          ...
          <Card className="p-6">
            ...
            <div className="mt-8 pt-6 border-t">
              ...
              <div className="space-y-3">
                {/* Free Plan */}
                <div className={`flex justify-between items-center p-3 rounded ${subscription?.planName === 'free' ? 'bg-blue-50 border border-blue-200' : 'bg-gray-50'}`}>
                  <div>
                    ...
                    <div className="text-sm text-gray-600">3 brand matches/month</div>
                  </div>
                ...
                {/* VIP Plan */}
                <div className={`flex justify-between items-center p-3 rounded ${subscription?.planName === 'vip' ? 'bg-blue-50 border border-blue-200' : 'bg-gray-50'}`}>
                  <div>
                    <div className="font-medium flex items-center">
                      VIP Plan
                      {subscription?.planName === 'vip' && (
